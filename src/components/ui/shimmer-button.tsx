  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden whitespace-nowrap border border-white/10 px-3 sm:px-5 lg:px-7 py-1.5 sm:py-2.5 lg:py-3.5 text-white [background:var(--bg)] [border-radius:var(--radius)] dark:text-black",
