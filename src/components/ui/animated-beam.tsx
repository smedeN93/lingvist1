...
import React, { RefObject, useEffect, useId, useState, forwardRef, useRef } from "react";
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex items-center justify-center rounded-full border-2 bg-white shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] overflow-hidden",
        className
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full items-center justify-center p-4 sm:p-6 md:p-8",
        className
      )}
      ref={containerRef}
    >
  ...
  <User size={24} />
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 p-1.5 sm:p-2 bg-black">
            <Image src="/lingvistlogo.svg" alt="Lingvist" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-3 sm:gap-4 md:gap-5">
          <Circle ref={div1Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 p-1.5 sm:p-2">
            <Image src="/aws-logo.svg" alt="AWS" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
          </Circle>
          <Circle ref={div2Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 p-1.5 sm:p-2">
            <Image src="/pinecone-logo.svg" alt="Pinecone" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
          </Circle>
          <Circle ref={div3Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 p-1.5 sm:p-2">
            <Image src="/neon-logo.svg" alt="Neon" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
          </Circle>
          <Circle ref={div4Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 p-1.5 sm:p-2">
            <Image src="/kinde-logo.svg" alt="Kinde" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
          </Circle>
          <Circle ref={div5Ref} className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 p-1.5 sm:p-2">
            <Image src="/stripe-logo.svg" alt="Stripe" width={40} height={40} style={{ width: 'auto', height: 'auto' }} />
          </Circle>
        </div>
      </div>
