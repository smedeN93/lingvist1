...
export const Dashboard = ({ subscriptionPlan }: DashboardProps) => {
  ...
  return (
    <div className="min-h-screen bg-[rgb(245,245,247)] p-4">
      <main className="mx-auto max-w-7xl md:p-10">
        <Card className="shadow-md rounded-2xl overflow-hidden transition-shadow duration-300 hover:shadow-lg">
          <CardContent className="p-6 min-h-[400px] lg:min-w-[1000px]">
            ...
            {/* Gendannede Originale Widgets */}
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-[rgb(245,245,247)] p-4 rounded-xl shadow-md flex items-center justify-between">
                ...
                {files
                  ...
                  .map((file) => (
                    ...
                    >
                      ...
                      <div className="px-6 py-4 bg-[rgb(245,245,247)] text-sm text-slate-500 flex items-center justify-between">
